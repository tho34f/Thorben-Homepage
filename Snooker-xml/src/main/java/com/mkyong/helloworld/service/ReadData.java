...
public class ReadData {
	...
	public void readData() {
		try {
		Scanner scanner1 = new Scanner(new File("D:/eclipse-workspace/Snooker/src/objekte/spieler.txt"),"UTF-8");
		Scanner scanner2 = new Scanner(new File("D:/eclipse-workspace/Snooker/src/objekte/tournament.txt"),"UTF-8");
