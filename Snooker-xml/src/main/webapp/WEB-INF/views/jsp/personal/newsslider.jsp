...
<div id="content" class="jumbotron">
	<div id="contenContainer" class="container">
		<h1 class="headingPersonal"><tho:out value="global.news"/></h1>
		<div id="inhalt" class="row">
			<c:if test="${not empty newsList}">
				...
				<article class="news-image-teaser">
					...
					<h2><a href="newsreader/${element.id}">${element.title}</a></h2>
					<div>${element.teaser}</div>
					<p><a href="newsreader/${element.id}"><span ><tho:out value="global.continue.reading"/></span></a></p>
				</article>
				</c:forEach>
			</c:if>
