			...
			<div class="content-widget-wrapper">
				<div class="content-widget-container">
					<div class="content-widget-content">
						...
						<ul>
							<li><p>Seit Juni 2023: Fachinformatiker; Fachrichtung: Softwareentwicklung</p></li>
							<li><p>August 2020 - Juni 2023: Ausbildung zum Fachinformatiker; Fachrichtung: Softwareentwicklung</p></li>
