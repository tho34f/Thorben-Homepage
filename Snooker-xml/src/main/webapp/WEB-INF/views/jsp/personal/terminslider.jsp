		...
		<div id="inhalt" class="row">
			<c:if test="${not empty terminList}">
				...
				<article class="news-image-teaser">
					...
					<p><a href="terminreader?id=${element.id}"><span >Weiterlesen... </span></a></p>
				</article>
				</c:forEach>
			</c:if>
				<nav aria-label="...">
					<ul class="pagination justify-content-center">
						<li class="page-item">
					      <a class="page-link" href="terminslider?action=back" tabindex="-1">Previous</a>
					    </li>
					    ...
					    <li class="page-item">
					      <a class="page-link" href="terminslider?action=next">Next</a>
					    </li>
				  </ul>
				</nav>
		</div>
