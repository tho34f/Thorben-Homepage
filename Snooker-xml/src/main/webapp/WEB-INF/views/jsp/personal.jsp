		...
		<nav class="navbar navbar-inverse navbar-expand-sm">
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"> Snooker </a>
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"> Persönliches </a>
      				<div class="dropdown-menu">
      					<a class="dropdown-item" href="/spring4/saisonOverwiev">Überblickt erzeugte Saisons</a>
						<a class="dropdown-item" href="/spring4/saison">Season</a>
					</div>
